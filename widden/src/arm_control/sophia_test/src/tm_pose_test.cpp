...
{  
  ...
  srv.request.positions.push_back(0.5508);
  srv.request.positions.push_back(-0.576);
  srv.request.positions.push_back(1.9309);
  srv.request.positions.push_back(0.2183);
  srv.request.positions.push_back(1.5586);
  srv.request.positions.push_back(0.5456);
  srv.request.velocity = 1.8;//rad/s
  srv.request.acc_time = 0.1;
