...
#define REPEATABILITY 0.002 //0.01//0.00005 //TODO: modify attractive force
...
std::vector<geometry_msgs::Point> static_path_simulate;
...
bool Hexagon_Demo()
{
    ...
    while(ros::ok()){
            ...
            for(int i = 0; i < 3; i++){
                if(i == 0){
                    if(Direction(exec_index, i, static_path)){
                        PassThrough_velocity[i] = ((static_path[exec_index-1].x - static_path[exec_index].x) + (static_path[exec_index].x - static_path[exec_index+1].x));
                    ...
                    if(Direction(exec_index, i, static_path)){
                        PassThrough_velocity[i] = ((static_path[exec_index-1].y - static_path[exec_index].y) + (static_path[exec_index].y - static_path[exec_index+1].y));
                        PassThrough_velocity[i] *= -1;
                    }
                    else{
                        PassThrough_velocity[i] = 0.0;
                    ...
                    if(Direction(exec_index, i, static_path)){
                        PassThrough_velocity[i] = ((static_path[exec_index-1].z - static_path[exec_index].z) + (static_path[exec_index].z - static_path[exec_index+1].z));
                        PassThrough_velocity[i] *= -1;
                    }
                    else{
                        PassThrough_velocity[i] = 0.0;
        ...
        TargetPosition = {static_path[exec_index].x, static_path[exec_index].y, static_path[exec_index].z, 0, 0, 0};
        ROS_WARN("TargetPosition: %lf, %lf, %lf", static_path[exec_index].x, static_path[exec_index].y, static_path[exec_index].z);
...
bool Hexagon_Demo_simulate()
{
    ...
    while(ros::ok()){
        ...
        ROS_WARN("Next pt : %lf, %lf, %lf", static_path_simulate[exec_index].x, static_path_simulate[exec_index].y, static_path_simulate[exec_index].z);
            ...
            for(int i = 0; i < 3; i++){
                if(i == 0){
                    if(Direction(exec_index, i, static_path_simulate)){
                        PassThrough_velocity[i] = ((static_path_simulate[exec_index-1].x - static_path_simulate[exec_index].x) + (static_path_simulate[exec_index].x - static_path_simulate[exec_index+1].x));
                        PassThrough_velocity[i] *= -1;
                    }
                    else{
                        PassThrough_velocity[i] = 0.0;
                    ...
                    if(Direction(exec_index, i, static_path_simulate)){
                        PassThrough_velocity[i] = ((static_path_simulate[exec_index-1].y - static_path_simulate[exec_index].y) + (static_path_simulate[exec_index].y - static_path_simulate[exec_index+1].y));
                        PassThrough_velocity[i] *= -1;
                    }
                    else{
                        PassThrough_velocity[i] = 0.0;
                    ...
                    if(Direction(exec_index, i, static_path_simulate)){
                        PassThrough_velocity[i] = ((static_path_simulate[exec_index-1].z - static_path_simulate[exec_index].z) + (static_path_simulate[exec_index].z - static_path_simulate[exec_index+1].z));
                        PassThrough_velocity[i] *= -1;
                    }
                    else{
                        PassThrough_velocity[i] = 0.0;
        ...
        TargetPosition = {static_path_simulate[exec_index].x, static_path_simulate[exec_index].y, static_path_simulate[exec_index].z, 0, 0, 0};
        ROS_WARN("TargetPosition: %lf, %lf, %lf", static_path_simulate[exec_index].x, static_path_simulate[exec_index].y, static_path_simulate[exec_index].z);
...
void get_path_callback_simulate(const geometry_msgs::PoseArray::ConstPtr& msg)
{
    ...
    for(int i = 0; i < static_path_simulate.size(); i++){
        printf("x: %10.4lf, y: %10.4lf, z: %10.4lf\n", static_path_simulate[i].x, static_path_simulate[i].y, static_path_simulate[i].z);
    }
