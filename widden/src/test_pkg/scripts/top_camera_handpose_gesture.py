...
###gesture ###
base_options_gesture = python.BaseOptions(model_asset_path='/home/tm5/widden/src/test_pkg/scripts/weight/gesture_recognizer0924.task',delegate=python.BaseOptions.Delegate.GPU)
