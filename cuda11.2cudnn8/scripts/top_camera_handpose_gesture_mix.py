...
LAST_TARGET_DIS = 0.45 #怕手掌太下面(之後可以根據交付物品去做變化)
...
# ###gesture ###
# base_options_gesture = python.BaseOptions(model_asset_path='/home/user/widden/docker_ws/src/handover/scripts/weight/gesture_recognizer0924.task')
    ...
    for idx in range(len(hand_landmarks_list)):
      ...
      try: 
        ...
        if ((self.depth0/1000 > LAST_TARGET_DIS)):
          print("top depth is :", self.depth0/1000)
...
def main():
  rospy.init_node('top_camera_handpose_gesture_mix', anonymous=True)
