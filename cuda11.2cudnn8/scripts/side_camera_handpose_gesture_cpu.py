...
###landmarks ###
base_options_landmark = python.BaseOptions(model_asset_path='/home/user/cuda11.2cudnn8/docker_ws/src/test_pkg/scripts/weight/hand_landmarker.task')
...
class handpose_mediapipe(object):
  ...
  def image_cb(self, image_msg, info_msg, depth_msg):
    ...
    try:
      ...
      cv2.putText(annotated_image, f"Gesture:{None}", (30, 70), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 1)
...
def main():
  rospy.init_node('side_camera_demo_handpose_0124', anonymous=True)
